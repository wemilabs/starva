      ...
      <Tailwind>
        ...
        <Body className="bg-gray-100 py-[40px] font-sans">
          <Container className="mx-auto max-w-[600px] rounded-[8px] bg-white p-[40px] shadow-sm">
            ...
            <Section className="mb-[32px] text-center">
              <Button
                className="box-border inline-block rounded-[6px] bg-orange-600 px-[24px] py-[12px] font-medium text-[16px] text-white no-underline"
            ...
            <Section className="border-gray-200 border-t pt-[24px]">
              ...
              <Text className="m-0 text-center text-[12px] text-gray-500">
                KK 456 Gatenga, Niboye, Kicukiro, Kigali, Republic of Rwanda
              </Text>
            </Section>
          </Container>
        </Body>
